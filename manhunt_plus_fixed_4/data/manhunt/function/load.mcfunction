...
# -- Game state --
scoreboard objectives add mh_phase dummy
scoreboard objectives add mh_timer dummy

# -- Cooldowns (in ticks) --
scoreboard objectives add mh_revealCD dummy
scoreboard objectives add mh_deceiveCD dummy
scoreboard objectives add mh_sabotCD dummy
...
# -- Lives --
scoreboard objectives add mh_lives dummy
...
scoreboard objectives add mh_sabotage trigger
